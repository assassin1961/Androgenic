...
export const ACHIEVEMENTS = [
  ...
  { id: 'five_scans', name: 'Selfie Addict', desc: 'Complete 5 face scans', icon: 'images-outline', color: '#0055dd', xp: 50 },
  ...
  { id: 'challenge_start', name: 'Challenger', desc: 'Start the 30-day challenge', icon: 'flag-outline', color: '#3388ff', xp: 20 },
  ...
  { id: 'improve_10', name: 'Major Glow Up', desc: 'Improve your overall score by 10+', icon: 'rocket', color: '#0055dd', xp: 200 },
  { id: 'pro_member', name: 'VIP', desc: 'Become a PRO member', icon: 'shield-checkmark', color: '#FFD700', xp: 100 },
  { id: 'night_owl', name: 'Night Owl', desc: 'Complete a routine after 10 PM', icon: 'moon', color: '#0055dd', xp: 25 },
];
